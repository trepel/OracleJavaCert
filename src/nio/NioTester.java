...
public class NioTester {
    ...
    public void pathTest() {
        ...
        Path p1              = Paths.get("/home/trepel", "githubRepos/OracleJavaCert", "pathTesting", "subdir1", "file1.txt"); //result: /home/trepel/OracleJavaCert/pathTesting/subdir1/file1.txt
        Path doubleSlashes  = Paths.get("//home//trepel"); // it is ok, the string is normalized
        Path isEqualsDS     = Paths.get("/home/./trepel/githubRepos/OracleJavaCert/pathTesting/../../.."); // not normalized, probably due to symlinks
    	// you can use p1.normalize() method, but it doesn't check if symlinks presence makes some mess
        Path p2             = doubleSlashes.resolve("githubRepos/OracleJavaCert"); // /home/trepel/OracleJavaCert
...
//        Path p1_to_relative = p1.relativize(relative);
        ...
        try {
            ...
            Path nonEmptyDir = Paths.get("/home/trepel/githubRepos/OracleJavaCert/pathTesting/nonEmptyDir");
            Path realFile = Paths.get("/home/trepel/githubRepos/OracleJavaCert/pathTesting/nonEmptyDir/a.txt");
            Path emptyDir = Paths.get("/home/trepel/githubRepos/OracleJavaCert/pathTesting/emptyDir");
            Path copiedDir = Paths.get("/home/trepel/githubRepos/OracleJavaCert/pathTesting/copyOrMoveSomethingHere/copiedNonEmptyDir");
            Path targetFile = Paths.get("/home/trepel/githubRepos/OracleJavaCert/pathTesting/copyOrMoveSomethingHere/copiedFileA.txt");
            ...
            System.out.println("was copied the content too? " +
            		Files.exists(Paths.get("/home/trepel/githubRepos/OracleJavaCert/pathTesting/copyOrMoveSomethingHere/copiedNonEmptyDir/a.txt")));
